...
subtitle: Part 12C - experts list
date: today
author:
  - name: 
        family: Krug
...
citation:
  type: report
  container-title: " IPBES Technical Guidelines: Part 12C - experts list"
  doi: 10.5281/zenodo.10004409
doi: 10.5281/zenodo.10004409
version: 1.0
...
**Prepared by Renske Gudde - IPBES Technical Support Unit for Knowledge and Rainer M. Krug - IPBES Task Force on Knowledge and Data.**

**Reviewed by Aidin Niamir and Yanina V. Sica - IPBES Technical Support Unit for Knowledge and Data and the IPBES Task Force on Knowledge and Data** 
...
![Example figure of the expert database and the specific assessment expert database, that are linked through the expert id. From the complete personal information, the email address can be added to the assessment expert database.](Experts_list_figure.png)
